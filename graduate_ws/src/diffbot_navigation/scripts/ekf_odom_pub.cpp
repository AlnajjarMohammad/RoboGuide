...
const double TICKS_PER_REVOLUTION = 512; // For reference purposes.
const double WHEEL_RADIUS = 0.0425; // Wheel radius in meters
const double WHEEL_BASE = 0.112; // Center of left tire to center of right tire
const double TICKS_PER_METER = 1784; // Original was 2800
